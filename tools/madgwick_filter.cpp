 ...
 * 
 * @details Code is based on the research paper called "An efficient orientation filter 
 *          for inertial and inertial/magnetic sensor arrays" by Sebastian O.H. Madgwick. 
