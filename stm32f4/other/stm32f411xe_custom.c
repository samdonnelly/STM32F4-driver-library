...
static const uint8_t ahb_psc_table[AHB_PSC_TABLE_SIZE] = 
{
    0, 0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4, 6, 7, 8, 9
};

static const uint8_t apb_psc_table[APB_PSC_TABLE_SIZE] = 
{
    0, 0, 0, 0, 1, 2, 3, 4
};
...
{
    sys_clk_frq = (rcc_get_sys_clk_frq() >> 
                   ahb_psc_table[(RCC->CFGR & RCC_CFGR_HPRE) >> 
                   RCC_CFGR_HPRE_Pos]); 
}
