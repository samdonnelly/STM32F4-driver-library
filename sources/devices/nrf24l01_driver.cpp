    ...
    uint8_t rf_ch_freq)
{
    ...
    // These settings are ommon between both PRX and PTX devices. Registers not chaned here remain 
...
void nrf24l01_rf_set_reg_write(void)
{
    ...
    nrf24l01_reg_write(NRF24L01_REG_RF_SET, rf_set); 
}
